...
glimpse
ymd
filter, select, group_by, summarize, unique, ungroup
geom_point, geom_vline, geom_hline, theme_classic
pull
tibble
lm, coef, summary
...
## memo (delete before publishing)
library, data, glimpse
mutate, group_by, summarize, ungroup, pivot_wider, spread
lm
`modelr` package
optional: add_predictions
geom_line, geom_boxplot, ggtitle, geom_smooth
